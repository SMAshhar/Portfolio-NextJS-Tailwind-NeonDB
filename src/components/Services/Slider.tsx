      ...
      {serviceData.map((item, index) => {
        return (
          <SwiperSlide
            key={index}
          >
            <div className="bg-[rgba(237,102,255,0.15)] h-max hover:shadow-lg hover:shadow-purple-500 rounded-lg px-6 py-8 flex sm:flex-col gap-x-6 sm:gap-x-0 group cursor-pointer hover:bg-[rgba(89,65,169,0.35)] transition-all duration-300">
              {/* icon */}
